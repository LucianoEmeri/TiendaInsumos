export const Newsletter = () => {
	return (
		<div className='relative bg-gray-500 text-white py-32'>
			{/* IMAGEN DE FONDO */}
			<div
				className='absolute inset-0 bg-cover bg-center opacity-70 h-full'
				style={{
					backgroundImage: 'url(https://sdygfmfocvxwbeoojqwh.supabase.co/storage/v1/object/public/product-images/img/newsletter.webp)',
				}}
			/>
			...
			<div className='container z-10 relative p-5 md:p-0'>
				<div className='w-full text-black bg-white p-12 space-y-5 md:w-[50%] lg:w-[40%]'>
					...
					<form className='flex flex-col gap-5 xl:flex-row'>
						...
						<button className='bg-red-600 text-white font-semibold rounded-full uppercase tracking-wider py-3 text-xs xl:px-5'>
							Suscribirme
						</button>
					</form>
				</div>
